...
@section('content')
    <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            ...
            <div class="content">
                <form class="form-horizontal" method="post" action="{{route('wechat.imgtext.save',['id' => $res->id])}}">
                    {{ csrf_field() }}
                    <div class="form-group">
                        <label class="control-label col-xs-12 col-sm-2">标题:</label>
                        <div class="col-xs-12 col-sm-6">
                            <input id="c-wechatnameen" class="form-control" name="row[title]" value="{{$res->title}}" type="text"></div>
                    </div>
                    <div class="form-group">

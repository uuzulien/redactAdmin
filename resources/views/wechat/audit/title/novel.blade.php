                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        ...
                        <ul class="nav nav-tabs" role="tablist">
                            <li class="active"><a href="{{route('title.audit.novel')}}">小说标题</a></li>
                            <li><a href="{{route('title.audit.active')}}">活动标题</a></li>
                            <li><a href="{{route('title.audit.signin')}}">签到标题</a></li>
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered">
                                ...
                                <tr>
                                    <td colspan="7"><div class="form-group"><label class="control-inline">

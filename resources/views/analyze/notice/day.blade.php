                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        <form class="form-inline">
                            ...
                            <div class="form-group">
                                <h5>&nbsp;</h5>
                                <input type="text" class="form-control datetimepicker" id="form-start_date" name="start_at" placeholder="开始日期" value="{{request()->input('start_at')}}" autocomplete="off">
                            </div>
                            <div class="form-group">
                                <h5>&nbsp;</h5>
                                <input type="text" class="form-control datetimepicker" id="form-end_date" name="end_at" placeholder="结束日期" value="{{request()->input('end_at')}}" autocomplete="off">
                            </div>
                            <div class="form-group">
                                <h5>&nbsp;</h5>
                            ...
                            <table class="table table-striped table-bordered">
                                ...
                                @forelse($list as $key => $item)
                                    <tr>
                                        ...
                                        <td>{{[1 => '活动', 2 => '书名', 3 => '签到', 4 => '继续阅读'][$item->task_type] ?? '异常类型'}}</td>
                                        ...
                                        <td>
                                            @switch($item->status)
                                                @case(0)
                                                    <span class="label label-info">待发送</span>
                                                    @break
                                                @case(1)
...
@section('js')
    ...
    <script>
        ...
        $('.datetimepicker').datetimepicker({
            ...
            startDate: $('#form-start_date').val(),
            endDate: $('#form-end_date').val()

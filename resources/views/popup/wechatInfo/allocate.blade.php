    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content" style="z-index: 19891015; width: 600px; height: 350px; top: 160px; left: 150px;">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="modalLabel">公众号分配
                    <span style="padding-left: 20px;font-size: 15px;color: #3994C7;"></span></h4>
            </div>
            <div class="modal-body tab-content">
                <form class="form-horizontal" method="post" action="{{route('wechat.account.allocate')}}">
                    {{ csrf_field() }}
                    <div class="row">
                                ...
                                <div class="table-responsive">
                                    <div class="modal-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-xs-12 col-sm-8">
                                                <select class="form-control" autocomplete="off" id="uid" name="user_id">

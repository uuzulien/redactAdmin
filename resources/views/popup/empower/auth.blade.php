    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal" method="post" action="{{route('empower.auth.transfer')}}">
                    {{ csrf_field() }}
                    <div class="row">
                        <div class="panel panel-default">
                            <div class="panel-body user-permission">
                                <div class="form-group">
                                    <label class="control-label col-xs-12 col-sm-3">被授权人:</label>
                                ...
                                <div>
                                    <div class="permission-heading wxv" style="height:auto;" id="permission-heading_wxv">
                                        @foreach ($userTree as $item)
                                            <span>
                                            <input class="wx-check" name="auth[]" type="checkbox" id="checkbox-{{$item['id']}}" value="{{$item['id']}}">
                                            <label style="padding-left:20px;line-height:25px;padding-right:10px;">{{$item['name']}}</label>
                                        </span>
                                        @endforeach

                    ...
                    <div class="select-link-box">
                        <ul>
                            @forelse($res['active_link'] as $link)
                                <a href="javascript:;" class="sales-item " data-type="1" data-url="{{$link->href}}">
                    ...
                    <div class="select-link-box">
                        <ul>
                            @forelse($res['novel_link'] as $link)
                                <a href="javascript:;" class="sales-item " data-type="2" data-bookid="{{$link->book_id}}" data-url="{{$link->href}}">
                    ...
                    <div class="select-link-box">
                        <ul>
                            @forelse($res['history_link'] as $link)
                                <a href="javascript:;" class="sales-item " data-type="4" data-url="{{$link->href}}">
                                    <p class="sales-item-text">{{$link->href}}</p>
                                </a>
                            @empty
                                请先添加继续阅读链接
